...
envsubst < ../../apps/kube-system/cilium/app/cilium-values.yaml > cni/values.yaml
...
envsubst < ../../apps/kube-system/kubelet-csr-approver/app/values.yaml > csr-approver/values.yaml
