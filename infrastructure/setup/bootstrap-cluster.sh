...
kubectl apply --server-side --kustomize ${REPO_ROOT}/kubernetes/main/bootstrap
...
kubectl apply -f ${REPO_ROOT}/kubernetes/main/cluster/vars/cluster-settings.yaml
sops --decrypt ${REPO_ROOT}/kubernetes/main/cluster/vars/cluster-secrets.sops.yaml | kubectl apply -f -

kubectl apply --server-side --kustomize ${REPO_ROOT}/kubernetes/main/cluster/config
